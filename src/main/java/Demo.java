...
public class Demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        cyrill = new String[]{"а", "б", "ч", "д", "э", "е", "ф", "г", "ғ", "ғ", "ҳ", "и", "ж", "к", "қ", "л", "м", "н", "о", "ў", "ў", "п", "р", "с", "ш", "т", "у", "в", "х", "й", "з", "ъ", "А", "Б", "Ч", "Д", "Е", "Э", "Ф", "Г", "Ғ", "Ғ", "Ҳ", "И", "Ж", "К", "Қ", "Л", "М", "Н", "О", "Ў", "Ў", "П", "Р", "С", "Ш", "Т", "У", "В", "Х", "Й", "З", "Ъ", "«", "»", "ь", "я", "Я", "ё", "Ё", "ю", "Ю"};
        latin = new String[]{"a", "b", "ch", "d", "e", "e", "f", "g", "g‘", "g'", "h", "i", "j", "k", "q", "l", "m", "n", "o", "o‘", "o'", "p", "r", "s", "sh", "t", "u", "v", "x", "y", "z", "’", "A", "B", "Ch", "D", "E", "E", "F", "G", "G‘", "G'", "H", "I", "J", "K", "Q", "L", "M", "N", "O", "O‘", "O'", "P", "R", "S", "Sh", "T", "U", "V", "X", "Y", "Z", "’", "“", "”", "’", "ya", "Ya", "yo", "Yo", "yu", "Yu"};
